...
if __name__=='__main__':
    ...
    # while 1:
        ...
        if train_kimg is None:
            train_kimg = len_labeled*1000
        else:
            train_kimg += len_labeled*100
        # print(train_kimg)
        os.system('ML_DATA=tfrecord CUDA_VISIBLE_DEVICES=0 python mixmatch.py --dataset={0} --w_match=75 --beta=0.75 --filters=32 --lr=0.0002 --train_kimg={1} --report_kimg={2}'.format(dataset, train_kimg, len_labeled*20))
